...
extern struct sys_device __initconfig_start[];
extern struct sys_device __initconfig0_start[];
extern struct sys_device __initconfig1_start[];
extern struct sys_device __initconfig2_start[];
extern struct sys_device __initconfig3_start[];
extern struct sys_device __initconfig4_start[];
extern struct sys_device __initconfig5_start[];
extern struct sys_device __initconfig6_start[];
extern struct sys_device __initconfig7_start[];
extern struct sys_device __initconfig_end[];

static struct sys_device *config_levels[] = {
	__initconfig0_start,
	__initconfig1_start,
	__initconfig2_start,
	__initconfig3_start,
